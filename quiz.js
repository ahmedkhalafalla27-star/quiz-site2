...
const TIME_PER_QUESTION = 45; // ثانية
const AD_INDICES = [9, 19, 29]; // أماكن ظهور إعلان داخل الاختبار
...
// منع الدخول المباشر بدون start=true (حماية الرابط المختصر)
if (!allowStart) {
...
function renderQuestion() {
  ...
  card.innerHTML = `
    ...
    ${
      showMidAd
        ? `<div class="ad-slot mid-ad">إعلان بين الأسئلة</div>`
        : ""
    }
  `;
  ...
  document.getElementById("exitBtn").addEventListener("click", () => {
    if (confirm("هل تريد الخروج؟")) location.href = "index.html";
  });
